...
#include <glm/glm.hpp> // for matrices and vector based types
...
#pragma region Initialization
    ...
    void VulkanApplication::framebufferResizeCallback(GLFWwindow* window, int width, int height) {
        auto renderer_instance = reinterpret_cast<VulkanApplication*>(glfwGetWindowUserPointer(window));
        renderer_instance->framebufferResized = true;
    }
...
#pragma region Commands
    void VulkanApplication::createCommandPool() {
        QueueFamilyIndices queueFamilyIndices = VulkanApplication::findQueueFamilies(physicalDevice);
    ...
    void VulkanApplication::createCommandBuffers() {
            // pre-allocate memory for all the commandbuffers
...
#pragma endregion
    ...
    void VulkanApplication::createGraphicsPipeline() {
        auto vertShaderCode = readFile("/home/skye/gitrepos/treeWalk/src/renderer/shaders/vert.spv");
        auto fragShaderCode = readFile("/home/skye/gitrepos/treeWalk/src/renderer/shaders/frag.spv");
...
#pragma region Main Loop
    ...
    void VulkanApplication::drawFrame() {
        // wait for fence to signal, and reset it
